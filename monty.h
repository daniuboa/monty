...
/**
 * struct stack_s - doubly linked list repreentation of a stack (or que)
 * @n: integer
 * @prev: points to the previous element of the stack (or que)
 * @next: points to the next element of the stack (or que)
 *
 ...
 * @queue: flag to determine if in a stack vd in a queue mode
